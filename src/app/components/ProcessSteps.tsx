        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s) => (
            <div key={s.title} className="bg-white rounded-2xl p-6 shadow-md border border-slate-100 text-center">
              ...
              <a href="/formulario" className="inline-block mt-4 bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-full font-bold text-sm transition-all duration-300 hover:shadow-lg">
                ✏️ Fill Form - {s.cta}
              </a>
            </div>
          ))}
